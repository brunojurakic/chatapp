...
public class OutgoingRequestDTO {
    ...
    public OutgoingRequestDTO(UUID id, UUID recipientId, String recipientName, String recipientUsername, String recipientPicture, String status, LocalDateTime createdAt) {
        this.id = id;
